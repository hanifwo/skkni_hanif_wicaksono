                ...
                <div class="col col-8 p-4 bg-light">
                    <form action="action/add.php" method="POST">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input id="id_buku" class="form-control" type="text" name="id_buku" placeholder="Id Buku">
                        </div>
                        
                        <div class="form-group mb-2">
                            <label for="judul">Judul buku</label>
                            <input id="judul" class="form-control" type="text" name="judul" placeholder="Judul Buku">
                        </div>
                        <div class="form-group mb-2">
                            <label for="penerbit">Penerbit buku</label>
                            <input id="penerbit" class="form-control" type="text" name="penerbit" placeholder="Penerbit Buku">
                        </div>
                        <div class="form-group mb-2">
                            <label for="kategori">Kategori buku</label>
                            <input id="kategori" class="form-control" type="text" name="kategori" placeholder="Kategori Buku">
                        </div>
                        <div class="form-group mb-2">
